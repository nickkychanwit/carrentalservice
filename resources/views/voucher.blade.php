    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
              @if(Session::has('alert-success'))
                <div class="alert alert-success">
                  <strong> {{ Session::get('alert-success') }} </strong> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                </div>
              @endif
              <form @submit.prevent = "submitForm" action="{{route('voucher.store')}}" method="post" id="addForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                 <div class="form-group">
                   <table>
                     <tr>
                       <th style="width:180px"><label for="name">Voucher Name</label></th>
                       <td><input type="text" class="form-control ; input " name="name"  id="vcname" placeholder="" required>  </td>
                 ...
                 <div class="form-group">
                   <table>
                     <tr>
                         ...
                         <td><input type="date" class="form-control ; input " name="startDate" id="vcstartdate" placeholder="" required></td>
                     </tr>
                   </table>
                 </div>
                 <div class="form-group">
                   <table>
                     <tr>
                       ...
                       <td><input type="date" class="form-control ; input " name="$endDate" id="vcexpdate"  placeholder="" required></td>
                     </tr>
                 ...
                 <div class="form-group">
                   <table>
                     <tr>
                       ...
                       <td ><select  class="form-control ; input " name="vctype"  id="vctype" required>
                 ...
                 <div class="form-group">
                   <table>
                     <tr>
                       ...
                       <td><input type="text" class="form-control ; input " name="$discount" id="vcdiscount" placeholder="" required></td>
                     </tr>
                   </table>
                 ...
                 <div class="form-group">
                   <table>
                     <tr>
                       ...
                       <td><input type="text" class="form-control ; input " name="$pointCosume" id="vcpoint" placeholder="" required></td>
                     </tr>
                   </table>
                 ...
                 <div class="form-group">
                   <table>
                     <tr>
                       ...
                       <td> <textarea  class="form-control " rows="7" cols="60" name="descript" id="vcdescript" placeholder="----description---" > </textarea></td>
                     </tr>
                   </table>
                 ...
                 <div class="content2">
                  ...
                  <input class="button is-primary btn-fill" type="submit" name="submit" value="Add Voucher">
              </div>
            </div>
         ...
         <div class="message-body" id="vue-app">
          ...
          <div class="box">
            <p class="boxhead">1000 Discount Voucher</p>

            <br>
            Discount 1000 Bath<br>
            Consume 15 point<br>
            <br>
            <button class="button is-primary btn-fill" type="button">Change</button>
          </div>
          <div class="box">
            <p class="boxhead">2000 Discount Voucher</p>

            <br>
            Discount 1500 Bath<br>
            Consume 20 point<br>
            <br>
            <button class="button is-primary btn-fill" type="button">Change</button>
          </div>
